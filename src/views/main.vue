    ...
    methods: {
      ...
      async create_client() {
        ...
        if (this.channel != "") {
          ...
          this.Emotes = Object.assign(this.Emotes, await apis.RetryOnError(apis.get7tvGlobalEmotes, [], 3))
          this.Messages.push({"tags":{"badge-info":null,"badges":{"game-developer":"1"},"color":"#FFFFFF","display-name":"juuuuuuuuuuuuuuuuuuuustrl","emotes":null,"first-msg":"0","id":"4e9b10fb-7e80-46b5-9652-efc894188334","mod":"0","returning-chatter":"0","room-id":"22484632","subscriber":"0","tmi-sent-ts":"1680165804876","turbo":"0","user-id":"407046453","user-type":null},"source":{"nick":"juuuuuuuuuuuuuuuuuuuustrl","host":"rj_st@rj_st.tmi.twitch.tv"},"command":{"command":"PRIVMSG","channel":"#forsen"},"parameters":"ApuApustaja TeaTime","BG":"0"})
          this.Messages.push({"tags":{"badge-info":null,"badges":{"game-developer":"1"},"color":"#FFFFFF","display-name":"juuuuuuuuuuuuuuuuuuuustrl","emotes":null,"first-msg":"0","id":"4e9b10fb-7e80-46b5-9652-efc894188334","mod":"0","returning-chatter":"0","room-id":"22484632","subscriber":"0","tmi-sent-ts":"1680165804876","turbo":"0","user-id":"407046453","user-type":null},"source":{"nick":"juuuuuuuuuuuuuuuuuuuustrl","host":"rj_st@rj_st.tmi.twitch.tv"},"command":{"command":"PRIVMSG","channel":"#forsen"},"parameters":"ApuApustaja TeaTime","BG":"1"})
    ...
    computed: {
      out_url() {
        ...
        if (this.selectedChannel != "") {
          ...
          if (this.padding != "1") additional_query += `&padding=${this.padding.trim()}`
